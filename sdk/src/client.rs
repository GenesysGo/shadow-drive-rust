    ...
    T: Signer,
{
    ...
    ///
    /// The underlying Solana RPC client is configured with 120s timeout and a [commitment level][cl] of [`processed`](solana_sdk::commitment_config::CommitmentLevel::Processed).
    ///
