...
use shadow_nft_standard::common::{token_2022, Prefix};
...
pub(super) async fn process(
    ...
    let (collection, if_init_collection): (Pubkey, Option<CreateCollectionArgs>) = {
        if has_existing_collection {
            ...
            let text_prompt = Text::new("").with_validator(&|input: &str| {
...
pub fn validate_and_convert_to_half_percent(input: &str) -> Result<u8, &'static str> {
